...
class PPOAlgo(BaseAlgo):
    ...
    def __init__(self, envs, acmodel, device=None, num_frames_per_proc=None, discount=0.99, lr=0.001, gae_lambda=0.95,
        ...
        # self.optimizer = torch.optim.Adam(self.acmodel.parameters(), lr, eps=adam_eps, weight_decay=1e-6)
        self.optimizer = torch.optim.Adam(self.acmodel.parameters(), lr, eps=adam_eps, betas=(0.9, 0.9))
        self.batch_num = 0
